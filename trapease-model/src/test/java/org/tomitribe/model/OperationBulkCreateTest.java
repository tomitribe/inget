...
public class OperationBulkCreateTest {

    @Test
    public void testOnClass() throws Exception {
        final Resources resources = Resources.name("OperationBulkCreateTest/testOnClass");
        ...
        // Generation.saveResults("OperationBulkCreateTest/testOnClass", "expected", resources.actual(".*\\.java$"));
    ...
    public void testOnField() throws Exception {
        final Resources resources = Resources.name("OperationBulkCreateTest/testOnField");
        ...
        // Generation.saveResults("OperationBulkCreateTest/testOnField", "expected", resources.actual(".*\\.java$"));
