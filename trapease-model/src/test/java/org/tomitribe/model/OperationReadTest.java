...
public class OperationReadTest {
    ...
    public void testOnClass() throws Exception {
        final Resources resources = Resources.name("OperationReadTest/testOnClass");
        ...
        Generation.saveResults("OperationReadTest/testOnClass", "expected", resources.actual(".*\\.java$"));
    ...
    public void testOnField() throws Exception {
        final Resources resources = Resources.name("OperationReadTest/testOnField");
        ...
        Generation.saveResults("OperationReadTest/testOnField", "expected", resources.actual(".*\\.java$"));
