...
public class OperationReadAllTest {

    @Test
    public void testOnClass() throws Exception {
        final Resources resources = Resources.name("OperationReadAllTest/testOnClass");
        ...
        Generation.saveResults("OperationReadAllTest/testOnClass", "expected", resources.actual(".*\\.java$"));
    ...
    public void testOnField() throws Exception {
        final Resources resources = Resources.name("OperationReadAllTest/testOnField");
        ...
        Generation.saveResults("OperationReadAllTest/testOnField", "expected", resources.actual(".*\\.java$"));
