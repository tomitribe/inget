...
public class OperationCreateTest {
    ...
    public void testOnClass() throws Exception {
        final Resources resources = Resources.name("OperationCreateTest/testOnClass");
        ...
        Generation.saveResults("OperationCreateTest/testOnClass", "expected", resources.actual(".*\\.java$"));
    ...
    public void testOnField() throws Exception {
        final Resources resources = Resources.name("OperationCreateTest/testOnField");
        ...
        Generation.saveResults("OperationCreateTest/testOnField", "expected", resources.actual(".*\\.java$"));
